<x-layouts.app>
    <article class="prose prose-headings:text-white text-white">
        ...
        <section>
            <h2>Persyaratan Permintaan DMCA</h2>
            <p>
                Kami menghormati hak kekayaan intelektual pihak lain dan mengharapkan
                pengguna kami melakukan hal yang sama.
                Jika Anda adalah pemilik hak cipta atau memiliki wewenang untuk bertindak
                atas nama pemilik hak cipta dan ingin
                melaporkan pelanggaran, silakan ajukan laporan DMCA.
            </p>
        </section>
        ...
        <section>
            ...
            <ul>
                ...
                <li>
                    Pernyataan: "Informasi dalam pemberitahuan ini akurat dan, di bawah
